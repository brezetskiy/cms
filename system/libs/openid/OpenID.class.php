<?php
/**
 * Интерфейс работы с OpenID протоколом
 *
 * @package Pilot
 * @subpackage User
 * @author Mewp
...
class LightOpenID { 
    ...
    protected $server, $version, $trustRoot, $aliases, $identifier_select = false, $ax = false, $sreg = false, $setup_url = null;
    ...
    function discover($url)
    {
        ...
        for ($i = 0; $i < 5; $i ++) {
            ...
            throw new ErrorException("OpenID Сервер по адресу <b>$url</b> не обнаружен", 404);
        }
        
        throw new ErrorException("
        	При попытке соединения с сервером провайдера произошла критическая ошибка! 
        	Пожалуйста, обратитесь в теъ. поддержку
        ", 500);
    }
