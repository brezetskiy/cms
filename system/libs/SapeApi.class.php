...
* $get_site_links = $connect->query('sape.get_site_links', array(998242, array('status' => 'WAIT_WM')))->cmd(); // метод с аргументом-фильтром
*
* @author Frenk1 aka Gudd.ini
* @contacts http://forum.sape.ru/member.php?u=22749
* @version 0
*/
class SapeApi{
    /**
    ...
    */
    protected $login = 'c_format';
    protected $password = '6ef6c6551fee40594dc48b19a7420802'; // md5
