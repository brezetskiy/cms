...
$query = "
	...
	(
		...
		/* Модули, в которых не привязаны разделы админинтерфейса */
...
$cmsTable->addColumn('description', '60%', 'left', 'Описание');
$cmsTable->addColumn('count', '10%', 'right', 'Привелегий');
...
?>
<div class="context_help"><span style="color:red;font-weight:bold;">Красным цветом</span> выделены модули, в которых не распределены привилегии</div>
