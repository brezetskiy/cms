...
$sliders_tmpl = Banner::getSlidersTmpl('mainslider');
$Template = new Template('banner/'.$sliders_tmpl);

$sliders = Banner::getSliders('mainslider');
$Template->iterateArray('/banner/', null, $sliders);

$TmplDesign->set('slider', $Template->display());
$TmplDesign->set('sliders_tmpl', $sliders_tmpl);
