...
if (Auth::isAdmin() && isset($Adminbar) && $Adminbar instanceof Adminbar) {
	...
	if (empty($Adminbar->buttons) && isset($page_info['structure_id'])) {
		$Adminbar->addButton('editor', 'site_structure', SITE_STRUCTURE_ID, cms_message("CMS", "�������������"), 'word.gif');
		$Adminbar->addButton('cms_edit', 'site_structure', SITE_STRUCTURE_ID, cms_message("CMS", "���������"), 'edit.gif');
		$Adminbar->addButton('cms_add', 'site_structure', $page_info['structure_id'], cms_message("CMS", "�������� ��������"), 'add.gif', "structure_id=$page_info[structure_id]");
		$Adminbar->addButton('cms_add', 'site_structure', SITE_STRUCTURE_ID, cms_message("CMS", "�������� ���������"), 'copy.png', "structure_id=".SITE_STRUCTURE_ID);
		$Adminbar->addLink('/Admin/Site/Structure/?structure_id='.$page_info['structure_id'], cms_message("CMS", "����������"), 'administrator.png');
		...
		if(IS_DEVELOPER){  
			...
			if(is_file("$script_url.php")){
				$Adminbar->addButton('editor_php', 'site_structure', SITE_STRUCTURE_ID, cms_message("CMS", "������������� ���"), 'php.png');
			}
			
			if(is_file("$script_url.tmpl")){
				$Adminbar->addButton('editor_tmpl', 'site_structure', SITE_STRUCTURE_ID, cms_message("CMS", "������������� ������"), 'tmpl.png');
			}
		}
	}
