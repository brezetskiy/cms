...
<table border="0" cellpadding="0" cellspacing="10"  class="form phones">		
	<tr>
		<td colspan="2">
			<a id="phone_block_form_link" href="javascript:void(0);" onclick="phone_error_clear(); $('#phone_block_container').toggle();">
				<img id="phone_block_form_img" src="/img/user/add.png" border="0" align="absmiddle" style="margin:2px 5px;">Добавить номер
			</a>
 				...
 				<div id="phone_block_container" class="phone_block_container">
					<div id="phone_block_form" class="phone_form">
						<div id="phone_block_form_hat" class="hat"> 
							<div id="phone_block_form_hat_left" style="float:left;"><img id="phone_block_form_hat_left_img" border="0" align="absmiddle" src="/img/user/mobile-phone.png"> <b id="phone_block_form_hat_left_title">Введите ваш номер</b></div>
						...
						<div id="phone_block_form_content" style="padding:10px;">
							...
							<a id="phone_block_add_link" href="javascript:void(0);" onclick="phone_add();" class="submit_phone_button">
								<img id="phone_block_add_img" src="/img/user/add_green.png" border="0" align="absmiddle" title="Добавить"> Добавить
							</a>
	...
	<?php if($this->global_vars['phones_count'] == 0): ?><tr><td colspan="2" style="color:grey; font-size:10px;">Список ваших телефонных номеров пуст</td></tr><?php endif; ?>
	<?php if($this->global_vars['phones_count'] > 1 && !$this->global_vars['is_main_exists']): ?>
		<tr><td colspan="2" style="color:red; font-size:10px;">Пожалуйста, определите Ваш основной телефонный номер</td></tr>
	<?php endif; ?>
	...
	<tr class="phone">
		<td class="entity">
			<a href="javascript:void(0);" title="Удалить" onclick="phone_delete(<?php echo $this->vars['/phones/'][$__key][$_phones_key]['id']; ?>);"><img src="/img/user/delete.png" border="0" align="absmiddle" style="margin:2px 5px;"></a>
			...
			<div style="float:right; margin-right:10px;"><label><input type="checkbox" <?php if($this->vars['/phones/'][$__key][$_phones_key]['is_main']): ?>disabled checked<?php else: ?>onclick="phone_set_main(<?php echo $this->vars['/phones/'][$__key][$_phones_key]['id']; ?>);"<?php endif; ?>> основной</label></div>
		</td>
	</tr>
	<?php 
			endwhile;
