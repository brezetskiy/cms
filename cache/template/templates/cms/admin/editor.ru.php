...
<form id="text_editor_form" action="/action/admin/cms/text_editor_save" method="post">
	...
	<div class="se_menu" style="width:100%;">
		...
		<tr>
				...
				<span class="se_toolgroup">
					...
					<span class="se_button"> 
						<a href="javascript:void(0);" class="se_off se_button_cms-quit" onclick="refreshParent(); return false;">
							<span class="se_icon" title="Закрыть редактор" style="background-image: url(/img/cms/text_editor/se_button_quit.png); background-position: 0pt 0px;"></span>
						</a>
					</span>  
				</span>
			...
			<td align="left"><span class="se_toolbar" ><span class="se_toolcomment" ><span class="se_comment" >сохранено в <b><?php echo $this->global_vars['save_dtime']; ?></b></span></span></span></td>
			<?php endif; ?>
		</tr>
		</table>
	</div>
