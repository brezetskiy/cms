...
<body>
	...
	<tr>
		<td></td>
		<td><input type="checkbox" id="border" name="border" value="1" <?php echo $this->vars['image_border']; ?>><label for="border">Рамка</label></td>
	</tr>
	<tr>
		<td></td>
		<td><input id="watermark" type="checkbox" name="watermark" value="true" <?php echo $this->vars['watermark']; ?>><label for="watermark">Водяной знак</label></td>
	</tr>
