...
<h1>Поздравляем система успешно установлена</h1>
	<ul>
	<li>База данных - <span><?php echo $this->vars['db_name']; ?></span></li>
	<li>Количество таблиц - <?php echo $this->vars['tb_count']; ?></li>
	<li>Количество процедур - <?php echo $this->vars['pd_count']; ?></li>
	</ul>
	
	<div>Пожалуйста удалите каталог <span>installation</span>  полностю, иначе Ваш сайт не загрузится</div><br/>
	<div>Для изменения настроек перейдите по <a href="<?php echo $this->vars['url']; ?>">ссылке</a></div>
