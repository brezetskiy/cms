...
<h2><?php echo $this->vars['title']; ?></h2>
	...
	<div class="ok_message">Пожалуйста, полностью удалите каталог installation, иначе Ваш сайт не загрузится</div>
	<?php else: ?>
	<div class="describe">
	...
	<table width="100%">	    	 
		...
		<tr>
		      <td align="right">Хост БД</td><td><input type="text" name="dbhost" value="<?php echo $this->vars['dbhost']; ?>"/></td>
		</tr>
		<tr>
		      <td align="right">Имя БД </td><td><input type="text" name="dbname" value="<?php echo $this->vars['dbname']; ?>"/><br /><span>(БД уже должна существовать)<span></td>
		</tr>
		<tr>
		      <td align="right">Логин к БД</td><td><input type="text" name="dbuser" value="<?php echo $this->vars['dbuser']; ?>"/></td>

		</tr>
		<tr>
		    <td align="right">Пароль к БД</td><td><input type="password" name="dbpass" value="<?php echo $this->vars['dbpass']; ?>"/></td>
		</tr>
				<tr><th colspan="2" align="left">
		      Админ
		</th></tr>
		<tr>
		      <td align="right">Логин (почтовый ящик)</td><td><input id="email" type="text" name="email" value="<?php echo $this->vars['email']; ?>"/></td>
		</tr>
		<tr>
		      <td align="right">Пароль</td><td><input type="password" name="password" value="<?php echo $this->vars['password']; ?>"/></td>
		</tr>		
		<tr>
