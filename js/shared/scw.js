...
function scwSetDefaultLanguage()
    {try
        ...
        {// English
         ...
         scwArrMonthNames       = ['Янв','Фев','Мар','Апр','Май','Июн','Июл','Авг','Сен','Окт','Ноя','Дек'];
         scwArrWeekInits        = ['Вс','Пн','Вт','Ср','Чт','Пт','Сб'];
         scwInvalidDateMsg      = 'Введена направильная дата.\n';
         scwOutOfRangeMsg       = 'Дата находится вне интервала.';
         scwDoesNotExistMsg     = 'Введенная дата не существует.';
         scwInvalidAlert        = ['Неверная дата (',') проигнорирована.'];
         scwDateDisablingError  = ['Ошибка ',' не является объектом Date.'];
...
//scwDisabledDates[0] = [new Date(2004,11,01), new Date()];
